...
#title of the window
root.title("Venkatesh Guttula - Message Encode and Decode")



#label

Label(root, text ='ENCODE DECODE by VG', font = 'arial 20 bold').pack()
Label(root, text ='Venkatesh Guttula', font = 'arial 20 bold').pack(side =BOTTOM)
